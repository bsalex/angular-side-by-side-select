    ...
    SideBySideSelectController.prototype = {
        ...
        setTargetItems: function (data) {
            ...
            for (var i = 0; i < targetItems.length; i++) {
                if (targetItems[i] != data[i]) {
                    equal = false;
                    break;
                }
            }

            if ((equal && (this.getTargetItems().length !== 0)) || (data === this.getTargetItems()) || ((data === undefined) && (this.getTargetItems().length === 0))) {
                return;
            }
                    ...
                    compile: function (element, attributes) {
                        ...
                        angular.forEach(replaceDirectivesMap, function (replaceDirectiveName, directiveName) {
                            ...
                            if (directiveNameValue !== undefined) {
                                var newElement = angular.element("<" + directiveNameValue + ">"),
